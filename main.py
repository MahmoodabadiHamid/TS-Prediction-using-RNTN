...
def main(outputName):
    ...
    # Loading dataset
    datasets = {}
    datasets['training'] = utils.loadDataset('sp500_train.csv');
    
    print("Training loaded !")
    
    datasets['testing'] = utils.loadDataset('sp500_test.csv');
    print("Testing loaded !")
    datasets['validating'] = utils.loadDataset('sp500_dev.csv');
